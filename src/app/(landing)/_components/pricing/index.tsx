...
export const PricingSection = (props: Props) => {
  return (
   ...
   <p className="text-sm md:text-center text-left text-muted-foreground">
    Grouple is a vibrant online community platform that emoiwers people to connect, <br className="hidden md:block" />
   ...
   <Card className="p-7 mt-10 md:w-auto w-full bg-themeBlack border-themeGray">
    <div className=" flex flex-col gap-2">
        ...
        <Button
            variant="default"
            className="bg-[#333337] w-full rounded-2xl text-white hover:texy-[#333337]">
                Start for free
            </Button>
        </Link>
    </div>
